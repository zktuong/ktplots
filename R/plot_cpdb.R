...
plot_cpdb <- function(
  ...
  col_start <- ifelse(colnames(pvals_mat)[DEFAULT_CLASS_COL] == "classification", DEFAULT_V5_COL_START, DEFAULT_COL_START)
  if (degs_analysis) {
  ...
  row.names(df) <- paste0(df$Var1, paste0(rep(DEFAULT_SEP, 3), collapse = ""), df$Var2)
