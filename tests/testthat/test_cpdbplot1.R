...
test_that("plot_cpdb works 4", {
    p <- plot_cpdb("B cell", "B cell", kidneyimmune, "celltype", means, pvals,
        split.by = "Experiment",
...
test_that("plot_cpdb works 5", {
    p <- plot_cpdb("B cell", "cell", kidneyimmune, "celltype", means, pvals,
        split.by = "Experiment",
...
test_that("plot_cpdb works 6", {
    p <- plot_cpdb("B cell", "CD4T cell", kidneyimmune, "celltype", means2, pvals2,
        gene.family = "custom_family", custom_gene_family = list(custom_family = c(
            "CXCL13",
            "CD274", "CXCR5"
        )), verbose = FALSE
    )
...
test_that("plot_cpdb works 7", {
    p <- plot_cpdb("B cell", "CD4T cell", kidneyimmune, "celltype", means2, pvals2,
        gene.family = "custom_family", custom_gene_family = data.frame(custom_family = c(
            "CXCL13",
            "CD274", "CXCR5"
        )), verbose = FALSE
    )
...
test_that("plot_cpdb2 works 1", {
    sce <- kidneyimmune
    p <- plot_cpdb2(
        cell_type1 = "B cell", cell_type2 = "CD4T cell",
        scdata = sce,
        idents = "celltype", # column name where the cell ids are located in the metadata
        means = means2,
        pvals = pvals2,
