---
title: "Introduction to ktplots"
output: rmarkdown::html_vignette
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{Introduction to ktplots}
...
```{r, message = FALSE, warning = FALSE}
plot_cpdb_heatmap(pvals = pvals2, cellheight = 10, cellwidth = 10)
```
...
```{r, message = FALSE, warning = FALSE}
plot_cpdb_heatmap(pvals = pvals2, cellheight = 10, cellwidth = 10, symmetrical = FALSE)
```
...
you can also toggle options to `split.by` and `genes.family`:
...
plot_cpdb(
    ...
    idents = "celltype",
    split.by = "Experiment",
    gene.family = c("Coinhibitory", "Costimulatory"),
